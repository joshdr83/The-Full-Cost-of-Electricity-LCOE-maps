C_make_min_cost_map_with_ext <- function(){
...
## LCOE 3 ###
  ...
  pdf(file = paste('Min_cost_map_with_ext.pdf', sep = ''), height = 7, width = 9)
  ...
  map("state", col = "black", fill = FALSE, add = TRUE, lty = 1, lwd = 0.2,
    projection="polyconic")  
  mtext(text = 'Scenario 2: without availability zones and with externalities', cex = 2, line = -1.25) #, col = 'white')
